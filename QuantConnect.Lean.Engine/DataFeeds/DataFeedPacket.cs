...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class DataFeedPacket
    {
        ...
        internal readonly ISecurityPrice security;
        internal readonly SubscriptionDataConfig configuration;
        internal readonly List<BaseData> data;

        /// <summary>
        /// The security
        /// </summary>
        public ISecurityPrice Security => security;

        /// <summary>
        /// The subscription configuration that produced this data
        /// </summary>
        public SubscriptionDataConfig Configuration => configuration;
        ...
        /// </summary>
        public List<BaseData> Data => data;
