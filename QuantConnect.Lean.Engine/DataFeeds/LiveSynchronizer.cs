...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    {
        private readonly AutoResetEvent _newLiveDataEmitted = new(false);
        ...
        protected override ITimeProvider GetTimeProvider()
        {
            ...
            {
                return new BrokerageExchangeTimeProvider(Algorithm.StartDate.ConvertToUtc(Algorithm.TimeZone));
            }
