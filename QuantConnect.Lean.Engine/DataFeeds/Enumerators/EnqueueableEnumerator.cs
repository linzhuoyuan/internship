...
namespace QuantConnect.Lean.Engine.DataFeeds.Enumerators
{
    ...
    public class EnqueueableEnumerator<T> : IEnumerator<T>
    {
        ...
        /// <summary>
        /// Gets the last item that was queued
        /// </summary>
        public T LastEnqueued => _lastEnqueued;

        /// <summary>
        /// Returns true if the enumerator has finished and will not accept any more data
        /// </summary>
        public bool HasFinished => _end || _disposed;
        ...
        /// <summary>
        /// Enqueue the new data into this enumerator
        /// </summary>
        ...
        public bool MoveNext()
        {
            ...
            if (!_blockingCollection.TryTake(out var current, _timeout))
            {
                _current = default(T);
