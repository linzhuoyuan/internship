...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class SubscriptionCollection : IEnumerable<Subscription>
    {
        ...
        public SubscriptionCollection()
        {
            ...
            var resolution = Time.OneMinute;
            _fillForwardResolution = Ref.Create(() => resolution, span => resolution = span);
        }
        ...
        /// <summary>
        /// Attempts to remove the subscription with the specified configuration from the collection.
        /// </summary>
        ...
        /// selecting the smallest resolution not equal to tick
        /// </summary>
