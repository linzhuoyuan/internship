...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class ZipEntryNameSubscriptionDataSourceReader : ISubscriptionDataSourceReader
    {
        ...
        /// </summary>
        /// <param name="dataCacheProvider"></param>
        ...
        private static Symbol SetSymbolProperties(Symbol symbol)
        {
            if (symbol.ID.Market is Market.Deribit or Market.FTX or Market.Binance)
            {
                symbol.SymbolProperties ??= SymbolProperties.GetDefault("USD");
                symbol.SymbolProperties.LotSize = 0.001m;
                symbol.SymbolProperties.MinimumPriceVariation = 0.001m;
            }
        ...
        public IEnumerable<BaseData> Read(SubscriptionDataSource source)
        {
            ...
            try
            {
                ...
                {
                    _dataCacheProvider.Fetch(source.Source);
                }
