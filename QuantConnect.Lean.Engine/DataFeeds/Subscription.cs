...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class Subscription : IEnumerator<SubscriptionData>
    {
        ...
        internal decimal realtimePrice;
        internal bool endOfStream;
        internal readonly bool isUniverseSelectionSubscription;
        internal readonly DateTime utcStartTime;
        internal readonly DateTime utcEndTime;
        internal SubscriptionData current;
        ...
        /// <summary>
        /// Gets the configuration for this subscriptions
        /// </summary>
        ...
        {
            get => endOfStream;
            private set => endOfStream = value;
        }

        /// <summary>
        /// Gets true if this subscription is used in universe selection
        /// </summary>
        public bool IsUniverseSelectionSubscription => isUniverseSelectionSubscription;

        /// <summary>
        /// Gets the start time of this subscription in UTC
        /// </summary>
        public DateTime UtcStartTime => utcStartTime;

        /// <summary>
        /// Gets the end time of this subscription in UTC
        /// </summary>
        public DateTime UtcEndTime => utcEndTime;
        ...
        /// </returns>
        public SubscriptionData Current
        {
            get => current;
        ...
        /// <summary>
        /// Event invocation for the <see cref="NewDataAvailable"/> event
        /// </summary>
