...
namespace QuantConnect.Lean.Engine.DataFeeds
{
    ...
    public class BacktestingOptionChainProvider : IOptionChainProvider
    {
        ...
        public IEnumerable<Symbol> GetOptionContractList(Symbol symbol, DateTime date)
        {
            ...
            {
                throw new NotSupportedException($"BacktestingOptionChainProvider.GetOptionContractList(): SecurityType.Equity Or SecurityType.Crypto is expected but was {symbol.SecurityType}");
            }
