...
namespace QuantConnect.Lean.Engine.Results
{
    ...
    public interface IResultHandler
    {
        ...
        bool IsPushOptionPrice { get; set; }
        ...
        void OptionPrice(OptionContract contract);
        ...
        void SendFinalResult(AlgorithmNodePacket job, Dictionary<string, Order> orders, Dictionary<DateTime, decimal> profitLoss, Dictionary<string, Holding> holdings, CashBook cashbook, StatisticsResults statisticsResults, Dictionary<string, string> banner);
