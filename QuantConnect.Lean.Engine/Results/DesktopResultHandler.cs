...
namespace QuantConnect.Lean.Engine.Results
{
    ...
    public class DesktopResultHandler : BaseResultsHandler, IResultHandler
    {
        ...
        public void SendFinalResult(AlgorithmNodePacket job, Dictionary<string, Order> orders, Dictionary<DateTime, decimal> profitLoss, Dictionary<string, Holding> holdings, CashBook cashbook, StatisticsResults statisticsResults, Dictionary<string, string> banner)
        {
        ...
        {
            DebugMessage($"DesktopResultHandler.OrderEvent():{trade.ToString()}");
        }
