...
namespace QuantConnect.Algorithm.CSharp
{
    ...
    public class SVI_GET : QCAlgorithm, IRegressionAlgorithmDefinition
    {
        ...
        public override void OnData(Slice slice)
        {
            ...
            if (slice.OptionChains.TryGetValue(OptionSymbol, out chain) && chain.Underlying.Price != 0)
            {
                ...
                for (int i = 0; i < strikeList.Count; ++i)
                {
                    ...
                    sviVols[i] = decimal.ToDouble(callContract.ImpliedVolatility);
                ...
                SviInterpolation svi = new SviInterpolation(strikes, strikes.Count, sviVols, _tau,
