    ...
    public class MainWindowViewModel : ViewModelBase
    {
        ...
        public IEnumerable<ToolPaneViewModel> Tools
        {
            get
            {
                ...
                #region Written by Wang
                yield return PositionDetailsPane;
                yield return VolatilitySmilePane;
                yield return GreeksPane;
                yield return RiskMatrixPane;
                yield return VolatilityPane;
                yield return PerformanceAttributionPane;
                #endregion
            }
        }
        ...
        #region Written by Wang
        public PositionDetailsPanelViewModel PositionDetailsPane { get; set; }
        public VolatilitySmilePanelViewModel VolatilitySmilePane { get; set; }
        public GreeksPanelViewModel GreeksPane { get; set; }
        public RiskMatrixPanelViewModel RiskMatrixPane { get; set; }
        public VolatilityPanelViewModel VolatilityPane { get; set; }
        public PerformanceAttributionPanelViewModel PerformanceAttributionPane { get; set; }
        #endregion
        ...
        public MainWindowViewModel(ISessionService resultService, IMessenger messenger, ILayoutManager layoutManager, StatusViewModel statusViewModel)
        {
            ...
            // TODO: These view-models should be injected
            ...
            PositionDetailsPane = ViewModelLocator.PositionDetailsPanel;
            VolatilitySmilePane = ViewModelLocator.VolatilitySmilePanel;
            GreeksPane = ViewModelLocator.GreeksPanel;
            RiskMatrixPane = ViewModelLocator.RiskMatrixPanel;
            VolatilityPane = ViewModelLocator.VolatilityPanel;
            PerformanceAttributionPane = ViewModelLocator.PerformanceAttributionPanel;
            ...
            _messenger.Register<GridRequestMessage>(this, message =>
            {
                ...
                // Calculate the index for this tab
        ...
        {
            _sessionService.OpenHistories(new HistoriesSessionParameters
            {
                FileName = fileName
            });
        }
        ...
        public AvalonDock.Themes.Theme DefaultTheme { get; set; } = new DarkTheme();
    }
}