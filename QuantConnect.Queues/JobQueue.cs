...
namespace QuantConnect.Queues
{
    ...
    public class JobQueue : IJobQueueHandler
    {
        ...
        private readonly string _algorithmPathPython = Config.Get("algorithm-path-python", "../../../Algorithm.Python/");
        private readonly Language _language = (Language)Enum.Parse(typeof(Language), Config.Get("algorithm-language"));
        ...
        private static string AlgorithmLocation =>
            ...
            PathHelper.CompletionPath(Config.Get("algorithm-location", "QuantConnect.Algorithm.CSharp.dll"));
        ...
        public AlgorithmNodePacket NextJob(out string location)
        {
            ...
            var algorithmId = Config.Get("algorithm-id", _algorithmTypeName);
            ...
            //Default run a back testing job.
        ...
        private string GetAlgorithmLocation()
        {
            ...
            {
                var pythonSource = _algorithmTypeName + ".py";
