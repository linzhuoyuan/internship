...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        public void SetFinishedWarmingUpWithoutNotify()
        {
            IsWarmingUp = false;
        }
        ...
        private IEnumerable<Slice> History(IEnumerable<HistoryRequest> requests, DateTimeZone timeZone)
        {
            ...
            var historyRequests = requests.Where(hr => !UniverseManager.ContainsKey(hr.Symbol)).ToList();
            ...
            return ((IAlgorithm)this).HistoryProvider.GetHistory(historyRequests, timeZone);
        }
