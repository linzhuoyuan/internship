    ...
    def CreateUniverses(self, algorithm):
        ...
        for key, grp in groupby(self.symbols, lambda s: (s.ID.Market, s.SecurityType)):
            ...
            if securityType == SecurityType.Base:
                ...
                # but we set it to TimeZones.Utc in AddData, also, since this is a manual universe, the time
                ...
                alwaysOpen = SecurityExchangeHours.AlwaysOpen(TimeZones.Utc)
                entry = self.MarketHours.SetEntry(market, symbolString, securityType, alwaysOpen, TimeZones.Utc)
            else:
