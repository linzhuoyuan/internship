...
namespace QuantConnect.Algorithm
{
    public partial class QCAlgorithm
    {
        ...
        private readonly ConcurrentDictionary<int, Dictionary<string,CustomerChartData>> _customerChartData = new ConcurrentDictionary<int, Dictionary<string,CustomerChartData>>();

        private readonly ConcurrentDictionary<string, GreeksChartData> _greeksChartData = new ConcurrentDictionary<string, GreeksChartData>();

        private readonly ConcurrentDictionary<string, GreeksPnlChartData> _greeksPnlChartData = new ConcurrentDictionary<string, GreeksPnlChartData>();
        ...
        public void Plot(string chart, string series, decimal value)
        {
            ...
            if (ReservedChartSeriesNames.TryGetValue(chart, out var reservedSeriesNames))
            {
        ...
        public List<CustomerChartData> GetCustomerChartDataAdds()
        {
            var data = _customerChartData.SelectMany(x => x.Value.Values.ToList()).ToList();

            _customerChartData.Clear();
            return data;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<GreeksChartData> GetGreeksChartData()
        {
            var data = _greeksChartData.Select(x => x.Value).ToList();
            _greeksChartData.Clear();
            return data;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public List<GreeksPnlChartData> GetGreeksPnlChartData()
        {
            var data = _greeksPnlChartData.Select(x => x.Value).ToList();
            _greeksPnlChartData.Clear();
            return data;
        }
        ...
        ///
        /// </summary>
        /// <param name="customerChartData"></param>
        public void Draw(CustomerChartData customerChartData)
        {
            customerChartData.Id = customerChartData.Name.GetHashCode();
            if (!_customerChartData.ContainsKey(customerChartData.Id))
            {
                _customerChartData.TryAdd(customerChartData.Id, new Dictionary<string, CustomerChartData>());                
            }
            _customerChartData[customerChartData.Id].Add(customerChartData.DataTime.ToString(),customerChartData);
        }

        /// <summary>
        /// 
        /// </summary>
        /// <param name="greeksChartData"></param>
        public void Draw(GreeksChartData greeksChartData)
        {
            _greeksChartData.TryAdd(greeksChartData.DataTime.ToString(), greeksChartData);
        }

        public void Draw(GreeksPnlChartData pnlChartData)
        {
            _greeksPnlChartData.TryAdd(pnlChartData.DataTime.ToString(), pnlChartData);
        }
    }
}