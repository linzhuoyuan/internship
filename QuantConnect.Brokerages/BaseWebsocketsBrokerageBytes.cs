...
namespace QuantConnect.Brokerages
{
    ...
    /// </summary>
    public abstract class BaseWebsocketsBrokerageBytes : Brokerage
    {
        ...
        /// </summary>
        protected IWebSocketBytes WebSocket;
        /// <summary>
        ...
        public BaseWebsocketsBrokerageBytes(string wssUrl, IWebSocketBytes websocket, RestClient restClient, string apiKey, string apiSecret, string market, string name) : base(name)
        {
            WebSocket = websocket;
        ...
        /// <param name="e"></param>
        public abstract void OnMessage(object sender, WebSocketMessageBytes e);
