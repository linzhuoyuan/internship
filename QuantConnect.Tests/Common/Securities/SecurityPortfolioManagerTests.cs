    ...
    public class SecurityPortfolioManagerTests
    {
        ...
        public void ComputeMarginProperlyAsSecurityPriceFluctuates()
        {
            ...
            var marginCallOrders = 
                portfolio.MarginCallModel.GetMarginCallOrders(out var issueMarginCallWarning);
        ...
        private class OrderProcessor : IOrderProcessor
        {
            private readonly ConcurrentDictionary<long, Order> _orders = new ConcurrentDictionary<long, Order>();
            private readonly ConcurrentDictionary<long, OrderTicket> _tickets = new ConcurrentDictionary<long, OrderTicket>();
            ...
            public RequestResult<Quote> AcceptRequestQuote(long quoteId)
            {
                throw new NotImplementedException();
            }

            public RequestResult<QuoteRequest> CancelQuoteRequest(long quoteId)
            {
                throw new NotImplementedException();
            }

            public RequestResult<Quote[]> QueryOptionQuote(long requestId)
            {
                throw new NotImplementedException();
            }

            public RequestResult<OptionPosition[]> QueryOptionPosition()
            {
                throw new NotImplementedException();
            }
