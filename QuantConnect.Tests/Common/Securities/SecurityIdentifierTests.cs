...
namespace QuantConnect.Tests.Common.Securities
{
    ...
    {
        private static SecurityIdentifier SPY => SecurityIdentifier.GenerateEquity(
            new DateTime(1998, 01, 02), "SPY", Market.USA);
        ...
        {
            var sid = new SecurityIdentifier("some-symbol", 0357960000000009900, "");
