...
namespace QuantConnect.Tests.Common
{
    ...
    public class SymbolTests
    {
        ...
        public void SurvivesRoundtripSerialization()
        {
            ...
            var actual = JsonConvert.DeserializeObject<Symbol>(json, _settings);
...
'ID':'EURGBP 5O'},'Value':0.72722,'Price':0.72722}]}";
        ...
        public void HandlesListTicksWithDifferentSymbols()
        {
            ...
            var actual = JsonConvert.DeserializeObject<List<BaseData>>(json, _settings);
        ...
        public void TickRoundTrip()
        {
            ...
            var json = JsonConvert.SerializeObject(tick, _settings);
            var actual = JsonConvert.DeserializeObject<Tick>(json, _settings);
            Assert.AreEqual(tick.Symbol, actual.Symbol);

            json = JsonConvert.SerializeObject(tick, _settings);
