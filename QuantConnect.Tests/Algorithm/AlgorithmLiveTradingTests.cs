...
namespace QuantConnect.Tests.Algorithm
{
    ...
    public class AlgorithmLiveTradingTests
    {
        ...
        private class NullBrokerage : IBrokerage
        {
            ...
            public void SetOrderCached(Order order)
            {
            }
            public List<TradeRecord> GetHistoryTrades()
            {
            ...
            public  void QueryExchangeAccountHoldings(string uId, string requestId)
            {
