...
namespace QuantConnect.Tests.Algorithm.Framework.Alphas
{
    ...
    public class BasePairsTradingAlphaModelTests : CommonAlphaModelTests
    {
        ...
        {
            return new BasePairsTradingAlphaModel(Lookback, _resolution);
        }
        ...
        {
            return $"{nameof(BasePairsTradingAlphaModel)}({Lookback},{_resolution},1)";
        }
        ...
        protected override IAlphaModel CreatePythonAlphaModel()
        {
            ...
            using (Py.GIL())
            {
                ...
                var instance = model(Lookback, _resolution);
