...
namespace QuantConnect.Tests.Algorithm
{
    ...
    public class AlgorithmTradingTests
    {
        ...
        public void OrderQuantityConversionTest()
        {
            ...
            algorithm.Portfolio.SetCash(150000);
            ...
            algorithm.Buy(Symbols.MSFT, 1);
            algorithm.Buy(Symbols.MSFT, 1.0);
            algorithm.Buy(Symbols.MSFT, 1.0m);
            algorithm.Buy(Symbols.MSFT, 1.0f);

            algorithm.Sell(Symbols.MSFT, 1);
            algorithm.Sell(Symbols.MSFT, 1.0);
            algorithm.Sell(Symbols.MSFT, 1.0m);
            algorithm.Sell(Symbols.MSFT, 1.0f);

            algorithm.Order(Symbols.MSFT, 1);
            algorithm.Order(Symbols.MSFT, 1.0);
            algorithm.Order(Symbols.MSFT, 1.0m);
            algorithm.Order(Symbols.MSFT, 1.0f);

            algorithm.MarketOrder(Symbols.MSFT, 1);
            algorithm.MarketOrder(Symbols.MSFT, 1.0);
            algorithm.MarketOrder(Symbols.MSFT, 1.0m);
            algorithm.MarketOrder(Symbols.MSFT, 1.0f);

            algorithm.MarketOnOpenOrder(Symbols.MSFT, 1);
            algorithm.MarketOnOpenOrder(Symbols.MSFT, 1.0);
            algorithm.MarketOnOpenOrder(Symbols.MSFT, 1.0m);

            algorithm.MarketOnCloseOrder(Symbols.MSFT, 1);
            algorithm.MarketOnCloseOrder(Symbols.MSFT, 1.0);
            algorithm.MarketOnCloseOrder(Symbols.MSFT, 1.0m);

            algorithm.LimitOrder(Symbols.MSFT, 1, 1);
            algorithm.LimitOrder(Symbols.MSFT, 1.0, 1);
            algorithm.LimitOrder(Symbols.MSFT, 1.0m, 1);

            algorithm.StopMarketOrder(Symbols.MSFT, 1, 1);
            algorithm.StopMarketOrder(Symbols.MSFT, 1.0, 1);
            algorithm.StopMarketOrder(Symbols.MSFT, 1.0m, 1);

            algorithm.StopLimitOrder(Symbols.MSFT, 1, 1, 2);
            algorithm.StopLimitOrder(Symbols.MSFT, 1.0, 1, 2);
            algorithm.StopLimitOrder(Symbols.MSFT, 1.0m, 1, 2);

            algorithm.SetHoldings(Symbols.MSFT, 1);
            algorithm.SetHoldings(Symbols.MSFT, 1.0);
            algorithm.SetHoldings(Symbols.MSFT, 1.0m);
            algorithm.SetHoldings(Symbols.MSFT, 1.0f);

            const int expected = 32;
            Assert.AreEqual(expected, algorithm.Transactions.LastOrderId);
        }
