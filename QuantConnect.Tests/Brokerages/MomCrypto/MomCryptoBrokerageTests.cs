...
{
    [TestFixture]
    public class MomCryptoBrokerageTests
    {
        private readonly List<Order> _orders = new List<Order>();
        private MomCryptoBrokerage _brokerage;
        private const decimal buyQuantity = 0.01m;
        ...
        public void PlacedOrderHasNewBrokerageOrderID()
        {
            ...
            var order = new MarketOrder(FutureSymbol, buyQuantity, DateTime.UtcNow) { Id = _idGen.Next() , Status = OrderStatus.New};
            _orders.Add(order);
            ...
            order = new MarketOrder(FutureSymbol, buyQuantity, DateTime.UtcNow) { Id = _idGen.Next(), Status = OrderStatus.New };
            _orders.Add(order);
        ...
        public void ClientPlacesMarketOrder()
        {
            ...
            var order = new MarketOrder(FutureSymbol, buyQuantity, DateTime.UtcNow) { Id = orderId, Status = OrderStatus.New };
        ...
        [Test, Description("测试卖出下市价单是否发送成功")]
        ...
        public void ClientPlacesLimitOrder()
        {
            ...
            var order = new LimitOrder(FutureSymbol, buyQuantity, limitPrice, DateTime.UtcNow, null) { Id = orderId, Status = OrderStatus.New };
        ...
        public void ClientFiresSingleOrderFilledEvent()
        {
            ...
            var mom = _brokerage;
            long orderId = _idGen.Next();
            var order = new MarketOrder(FutureSymbol, buyQuantity, new DateTime()) { Id = orderId, Status = OrderStatus.New };
        ...
        public void GetsAccountHoldings()
        {
            ...
            foreach (var holding in newHoldings)
            {
                if (holding.Symbol.ID.Symbol == FutureSymbol.Value)
                {
                    Assert.IsTrue(positionVolume + buyQuantity == holding.Quantity, "holding Quantity Not Equal");
                }
            }
        }
        ...
        public void FiresMultipleAccountBalanceEvents()
        {
            ...
            var accountChangedFired = new AutoResetEvent(false);
            mom.AccountChanged += (sender, args) =>
            {
            ...
            Assert.GreaterOrEqual(orderCount, cashBalanceUpdates.Count);
        }
        ...
        public void GetsCashBalanceAfterTrade()
        {
            ...
            var order = new MarketOrder(FutureSymbol, buyQuantity, DateTime.UtcNow)
            {
                Id = _idGen.Next(),
                Status = OrderStatus.New
            };
        ...
        public void BuyStopLimitOrderBelowLastPrice()
        {
            ...
            limitPrice = limitPrice.RoundToSignificantDigits(n);
            long orderId = _idGen.Next();
            var order = new StopLimitOrder(FutureSymbol, buyQuantity, limitPrice, limitPrice, DateTime.UtcNow, null) { Id = orderId, Status = OrderStatus.New };
        ...
        public void BuyStopMarketOrderBelowLastPrice()
        {
            ...
            long orderId = _idGen.Next();
            var order = new StopMarketOrder(FutureSymbol, buyQuantity, stopPrice, DateTime.UtcNow, null) { Id = orderId, Status = OrderStatus.New };
        ...
        public void ClientCancelsMarketOrderAfterFilled()
        {
            ...
            long orderId = _idGen.Next();
            // try to sell a single share at a ridiculous price, we'll cancel this later
            var order = new MarketOrder(FutureSymbol, -buyQuantity,  DateTime.UtcNow, null) { Id = orderId, Status = OrderStatus.New };
        ...
        public void OrderStatusTradeAfterCompareWithQuery()
        {
            ...
            Assert.AreEqual(o.Status, oldStatus);
        }
        ...
        public void AlgorithmMarketOrder()
        {
            ...
            _algorithm.SetCash("USDT",10000000);
            ...
            //开始策略
            var results =  ((QCAlgorithm) _algorithm).MarketOrder(FutureSymbol, buyQuantity);
        ...
        public void AlgorithmLimitOrderAndCancle()
        {
            ...
            //开始策略
            var results = ((QCAlgorithm)_algorithm).LimitOrder(FutureSymbol, buyQuantity, limitPrice);
            orderedResetEvent.WaitOne(3000);
            Assert.IsFalse(placeOrderFailed, $"PlaceOrder Failed : {placeOrderFailedMsg}");
        ...
        internal static Security CreateFutureSecurity(Symbol symbol)
        {
            ...
            var security = new Future(symbol,
                ...
                new Cash("USDT", 0, 1),
                new SymbolProperties("", "USDT", 1m, 0.01m, 0.000001m),
