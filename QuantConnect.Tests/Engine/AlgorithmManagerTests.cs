...
namespace QuantConnect.Tests.Engine
{
    ...
    public class AlgorithmManagerTests
    {
        ...
        public class NullLeanManager : ILeanManager
        {
            ...
            public void SetPauseAlgorithm(bool pause)
            {
        ...
        class NullResultHandler : IResultHandler
        {
            ...
            public bool IsActive { get; }
            public bool IsPushOptionPrice { get; set; }
            ...
            public void RunEchart()
            {
                throw new NotImplementedException();
            }

            public void SampleRangeEchart(List<EchartJson> samples)
            {
                throw new NotImplementedException();
            }
            /*
        ...
        private class NullTransactionHandler : ITransactionHandler
        {
            ...
            public bool IsActive { get; }
            public ConcurrentDictionary<long, Order> Orders { get; }
            public ConcurrentDictionary<long, OrderTicket> OrderTickets { get; }
