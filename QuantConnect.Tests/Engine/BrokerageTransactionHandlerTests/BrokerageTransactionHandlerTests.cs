...
namespace QuantConnect.Tests.Engine.BrokerageTransactionHandlerTests
{
    ...
    class BrokerageTransactionHandlerTests
    {
        ...
        public void UpdateOrderRequestShouldWork()
        {
            ...
            // Mock the the order processor
            var orderProcessorMock = new Mock<IOrderProcessor>();
            orderProcessorMock.Setup(m => m
                .GetOrderTicket(It.IsAny<int>()))
        ...
        public void AddOrderWaitsForOrderToBeProcessed()
        {
            ...
            Assert.IsTrue(ticket.First<OrderTicket>().HasOrder);
        }
        ...
        {
            public long CancelPendingOrdersSize => _cancelPendingOrders.GetCancelPendingOrdersSize;
