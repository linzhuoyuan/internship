...
namespace QuantConnect.Securities
{
    ...
    public class SecurityExchange
    {
        ...
        internal SecurityExchangeHours exchangeHours;

        /// <summary>
        /// Gets the <see cref="SecurityExchangeHours"/> for this exchange
        /// </summary>
        public SecurityExchangeHours Hours => exchangeHours;

        /// <summary>
        /// Gets the time zone for this exchange
        /// </summary>
        public DateTimeZone TimeZone => exchangeHours.TimeZone;
        ...
        /// </summary>
        public bool ExchangeOpen => exchangeHours.IsOpen(_localFrontier, false);
        ...
        public void SetMarketHours(IEnumerable<MarketHoursSegment> marketHoursSegments, params DayOfWeek[] days)
        {
            ...
            var marketHours = exchangeHours.MarketHours.ToDictionary();
            marketHoursSegments = marketHoursSegments as IList<MarketHoursSegment>
                                  ??
                                  marketHoursSegments.ToList();
