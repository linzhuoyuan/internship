...
namespace QuantConnect.Securities
{
    ...
    public interface ISettlementModel
    {
        ...
        /// <param name="currency">The currency symbol</param>
        /// <param name="amount">The amount of cash to apply</param>
        void ApplyFundsForFrozen(SecurityPortfolioManager portfolio, Security security, DateTime applicationTimeUtc, string currency, decimal frozenamount, decimal amount);
    }
}
