...
namespace QuantConnect.Securities
{
    ...
    public class AccountCurrencyImmediateSettlementModel : ISettlementModel
    {
        ...
        /// <param name="applicationTimeUtc">The fill time (in UTC)</param>
        /// <param name="currency">The currency symbol</param>
        /// <param name="frozenamount">The frozenamount of cash to apply</param>
        /// <param name="amount">The amount of cash to apply</param>
        public void ApplyFundsForFrozen(SecurityPortfolioManager portfolio, Security security, DateTime applicationTimeUtc, string currency, decimal frozenamount, decimal amount)
        {
            var frozenAmountInAccountCurrency = portfolio.CashBook.ConvertToAccountCurrency(frozenamount, currency);
            var amountInAccountCurrency = portfolio.CashBook.ConvertToAccountCurrency(amount, currency);

            portfolio.CashBook[portfolio.CashBook.AccountCurrency].AddFrozenAmount(frozenAmountInAccountCurrency,amountInAccountCurrency);
        }
    }
}
