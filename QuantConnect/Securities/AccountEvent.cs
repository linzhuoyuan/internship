...
namespace QuantConnect.Securities
{
    ...
    public class AccountEvent
    {
        ...
        public AccountEvent(string currencySymbol, decimal cashBalance, bool settled = true)
        {
        ...
        {
            return string.Format("Account {0} Balance: {1} Settled: {2}", CurrencySymbol, CashBalance.ToString("0.00"),Settled.ToString());
        }
    }
}
