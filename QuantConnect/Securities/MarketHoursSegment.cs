...
namespace QuantConnect.Securities
{
    ...
    {
        internal readonly TimeSpan start;
        internal readonly TimeSpan end;
        internal readonly MarketHoursState state;
        ...
        /// </summary>
        [JsonProperty("state")]
        public MarketHoursState State => state;
            ...
            TimeSpan extendedMarketClose)
        {
            ...
            {
                segments.Add(new MarketHoursSegment(
                    MarketHoursState.PreMarket, extendedMarketOpen, marketOpen));
            }
            ...
            {
                segments.Add(new MarketHoursSegment(
                    MarketHoursState.PostMarket, marketClose, extendedMarketClose));
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Overlaps(TimeSpan startTime, TimeSpan endTime)
        {
