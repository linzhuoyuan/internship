...
namespace QuantConnect.Securities
{
    ...
    public class SecurityTransactionManager : IOrderProvider
    {
        ...
        private const decimal MinOrderSize = 0;
        ...
        /// </summary>
        public DateTime UtcTime => _securities.UtcTime;

        public bool LiveMode => _algorithm.LiveMode;
        ...
        public decimal MinimumOrderSize => MinOrderSize;
        ...
        public int MinimumOrderQuantity => MinOrderQuantity;

        /// <summary>
        /// Get the last order id.
        /// </summary>
        public long LastOrderId => _idGen.Current();
        //{
        //    get
        //    {
        //        //return _orderId;
        ...
        {
            if (_algorithm is { IsWarmingUp: true })
            {
                throw new Exception(OrderResponse.WarmingUp(request).ToString());
            }

            if (request is SubmitOrderRequest submit)
            {
        ...
        /// <returns>New unique, increasing order id</returns>
        ...
        /// </summary>
        public int OrdersCount => _orderProcessor.OrdersCount;
        ...
        /// <summary>
        /// pang 设置他的初始OrderId for deribit
        /// </summary>
        /// <param name="maxOrder"></param>
        //public void InitializeOrderId(int maxOrder)
        //{
        //    Interlocked.Exchange(ref _orderId, maxOrder);
        //}
        ...
        {
            return order.Status is OrderStatus.Filled or OrderStatus.PartiallyFilled or OrderStatus.Invalid or OrderStatus.Canceled;
        }
