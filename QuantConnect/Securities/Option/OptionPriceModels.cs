...
namespace QuantConnect.Securities.Option
{
    ...
    public static class OptionPriceModels
    {
        ...
        /// </summary>
        /// <returns>New option price model instance</returns>
        public static IOptionPriceModel MonteCarlo()
        {
            return new QLOptionPriceModel(process => new MCEuropeanEngine<PseudoRandom, GeneralStatistics>(process,
                100, null, false, false, 1000, null, 1000, 42),
                                           _underlyingVolEstimator,
                                           _riskFreeRateEstimator,
                                           _dividendYieldEstimator);
        }
