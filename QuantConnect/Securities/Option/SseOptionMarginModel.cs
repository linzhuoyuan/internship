...
namespace QuantConnect.Securities.Option
{
    ...
    /// </summary>
    public class SseOptionMarginModel : SecurityMarginModel
    {
        // initial margin
            ...
            InitialMarginRequiredForOrderParameters parameters)
        {
            ...
            var orderValue = parameters.Order.Direction == OrderDirection.Sell ? parameters.Order.Quantity * GetInitialMarginRequirement(parameters.Security) : value;
