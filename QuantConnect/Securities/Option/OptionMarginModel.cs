...
namespace QuantConnect.Securities.Option
{
    ...
    /// </summary>
    /// <remarks>
    /// 期权不是以保证金交易的。但对于那些持有空头头寸的投资组合，存在保证金要求
    /// 目前的只涵盖单一多头/无担保空头期权头寸
    /// </remarks>
    public class OptionMarginModel : SecurityMarginModel
    {
        ...
        ///// <param name="offset">The offset of the trade</param>
        ///// <returns>The margin available for the trade</returns>
        //protected override decimal GetMarginRemaining(SecurityPortfolioManager portfolio, Security security, OrderDirection direction, OrderOffset offset = OrderOffset.None)
        //{
        ...
        /// <param name="value">Holding value 订单市值或者是持仓市值</param>
        /// <returns></returns>
        private decimal GetMarginRequirement(Security security, decimal value)
        {
            ...
            // value :market value,value>0, is buy. so return 1 .买入权利仓保证金为1
            if (value > 0m)
            {
