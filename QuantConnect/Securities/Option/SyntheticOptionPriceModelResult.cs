...
namespace QuantConnect.Securities.Option
{
    ...
    /// </summary>
    public class SyntheticOptionPriceModelResult
    {
        ...
        public SyntheticOptionPriceModelResult(decimal theoreticalPrice, Greeks greeks)
        {
        ...
        /// <param name="greeks">The sensitivities (greeks) computed by the price model</param>
        public SyntheticOptionPriceModelResult(decimal theoreticalPrice, Func<decimal> impliedVolatility, Func<Greeks> greeks)
        {
            TheoreticalPrice = theoreticalPrice;
            _greeks = new Lazy<Greeks>(greeks);
        }
