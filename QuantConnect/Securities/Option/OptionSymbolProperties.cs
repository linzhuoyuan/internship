...
namespace QuantConnect.Securities.Option
{
    ...
    public class OptionSymbolProperties : SymbolProperties
    {
        ...
        {
            ContractUnitOfTrade = (decimal)contractMultiplier;
        }
        ...
        public OptionSymbolProperties(SymbolProperties properties)
            : base(properties.Description,
                 ...
                 properties.LotSize)
        {
            ContractUnitOfTrade = (decimal)properties.ContractMultiplier;
        }

        internal void SetContractUnitOfTrade(decimal unitOfTrade)
        {
