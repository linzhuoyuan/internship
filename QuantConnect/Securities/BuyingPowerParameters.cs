...
namespace QuantConnect.Securities
{
    ...
    public class BuyingPowerParameters
    {
        ...
        /// <param name="offset">The offset to compute buying power in</param>
        /// <param name="orderid">The orderid to compute buying power in</param> 
        public BuyingPowerParameters(SecurityPortfolioManager portfolio, Security security, OrderDirection direction, OrderOffset offset = OrderOffset.None, long orderid =0)
        {
            Portfolio = portfolio;
            Security = security;
            Direction = direction;
