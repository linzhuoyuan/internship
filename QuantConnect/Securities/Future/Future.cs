...
namespace QuantConnect.Securities.Future
{
    ...
    public class Future : Security, IDerivativeSecurity
    {
                ...
                )
        {
            ...
            if (this.Symbol.ID.Market == Market.Okex && liveMode)
            {
                Holdings = new OkexFutureHolding(this, currencyConverter);
            }
            else if (this.Symbol.ID.Market == Market.Deribit)
            {
                Holdings = new DeribitFutureHolding(this, currencyConverter);
                PortfolioModel = new DeribitFuturePortfolioModel();
            }
            else
            {
            ...
            SetFilter(TimeSpan.Zero, TimeSpan.FromDays(4000));
        }
