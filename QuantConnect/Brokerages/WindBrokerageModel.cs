...
{
    /// <summary>
    /// Provides properties specific to Wind
    /// </summary>
    public class WindBrokerageModel : DefaultBrokerageModel
    {
        ...
        public WindBrokerageModel(AccountType accountType = AccountType.Margin)
            : base(accountType)
        {
        }
        ...
        private bool IsForexWithinOrderSizeLimits(string currencyPair, decimal quantity, out BrokerageMessageEvent message)
        {
            ...
            ForexCurrencyLimits.TryGetValue(baseCurrency, out var max);
