...
namespace QuantConnect.Packets
{
    ...
    public class LiveResult : Result
    {
        ...
        /// </summary>
        public LiveResult(IDictionary<string, Chart> charts, IDictionary<string, Order> orders, IDictionary<DateTime, decimal> profitLoss, IDictionary<string, Holding> holdings, CashBook cashbook, IDictionary<string, string> statistics, IDictionary<string, string> runtime, IDictionary<string, string> serverStatistics = null)
        {
            Charts = charts;
            Orders = orders;
