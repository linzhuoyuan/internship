...
namespace QuantConnect.Python
{
    ...
    public class FeeModelPythonWrapper : FeeModel
    {
        ...
        /// <summary>
        /// Constructor for initializing the <see cref="FeeModelPythonWrapper"/> class with wrapped <see cref="PyObject"/> object
        /// </summary>
        ...
        public override OrderFee GetOrderFee(OrderFeeParameters parameters)
        {
            using (Py.GIL())
            {
                ...
                var fee = (_model.GetOrderFee(parameters.Security, parameters.Order) as PyObject).GetAndDispose<decimal>();
