...
namespace QuantConnect.Data.Market
{
    ...
    public class OpenInterest : Tick
    {
        ...
        /// <summary>
        /// underlying pre-day close
        /// </summary>
        public decimal UnderlyingPreDayClose;
        ...
        public OpenInterest()
        {
            ...
            Symbol = Symbol.Empty;
            PreDayClose = 0;
            UnderlyingPreDayClose = 0;
            PreDaySettlementPrice = 0;
        }
        ...
        public OpenInterest(OpenInterest original)
        {
            ...
            PreDayClose = original.PreDayClose;
            UnderlyingPreDayClose = original.PreDayClose;
            PreDaySettlementPrice = original.PreDaySettlementPrice;
        }
        ...
        public OpenInterest(SubscriptionDataConfig config, Symbol symbol, string line, DateTime baseDate, decimal preDayClose = 0, decimal underlyingPreDayClose = 0, decimal PreDaySettlementPrice = 0)
        {
            var csv = line.Split(',');
            DataType = MarketDataType.Tick;
            TickType = TickType.OpenInterest;
            ...
            if (csv[2].Length >0 ) {
                PreDayClose = csv[2].ToDecimal();
            }
            if (csv[3].Length > 0)
            {
                UnderlyingPreDayClose = csv[3].ToDecimal();
            }
