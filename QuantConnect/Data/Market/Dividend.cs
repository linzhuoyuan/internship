...
namespace QuantConnect.Data.Market
{
    ...
    public class Dividend : BaseData
    {
        ...
        public bool ExDividend
        {
            get;
            set;
        }

        public bool PayDividend
        {
            get;
            set;
        }
        ...
        /// <param name="decimalPlaces">The number of decimal places to round the result to, defaulting to 3</param>
        /// <returns>The distribution rounded to the specified number of decimal places, defaulting to 3</returns>
        public static decimal ComputeDistribution(decimal close, decimal priceFactorRatio, int decimalPlaces = 3)
        {   
            //股票分红改动。股票金额·分红由保留两位小数点改为三位小数点 writter ：lh
