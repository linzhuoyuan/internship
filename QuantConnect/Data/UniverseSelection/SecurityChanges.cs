...
namespace QuantConnect.Data.UniverseSelection
{
    ...
    public class SecurityChanges
    {
        ...
        /// </summary>
        public static readonly SecurityChanges None = new(new List<Security>(), new List<Security>());
        ...
        public static SecurityChanges operator +(SecurityChanges left, SecurityChanges right)
        {
            ...
            var additions = left
                .AddedSecurities
                .Union(right.AddedSecurities)
                .ToList();
            var removals = left
                .RemovedSecurities
                .Union(right.RemovedSecurities)
                .Where(x => !additions.Contains(x))
                .ToList();
        ...
        public void Clear()
        {
            _addedSecurities.Clear();
            _removedSecurities.Clear();
        }
