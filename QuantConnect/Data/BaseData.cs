...
namespace QuantConnect.Data
{
    ...
    {
        internal bool isFillForward;
        internal MarketDataType dataType = MarketDataType.Base;
        internal DateTime time;
        internal DateTime endTime;
        internal Symbol symbol = Symbol.Empty;
        internal decimal value;

        public DateTimeZone ExchangeTimeZone => symbol.ExchangeTimeZone;

        //theone for test add a ID 
        ...
        protected virtual void SetTime(DateTime dateTime)
        {
            time = dateTime;
            endTime = dateTime;
        }

        protected virtual void SetEndTime(DateTime dateTime)
        {
            time = dateTime;
            endTime = dateTime;
        }
...
#pragma warning restore 618
        ...
        public virtual void Update(
            decimal lastTrade, decimal bidPrice, decimal askPrice, decimal volume, decimal bidSize, decimal askSize)
        {
            value = lastTrade;
        }
        ...
        //public static string TestSymbolValue()
        //{
        //    return "BTC-27MAR20-10000-C";
        //}

        //public static bool IsTestData()
        //{
        //    return true;
        //}
    }
