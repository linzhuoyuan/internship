...
namespace QuantConnect.Data.Custom.Tiingo
{
    ...
    public class TiingoDailyData : TradeBar
    {
        ...
        {
            if (!_startDates.TryGetValue(config.Symbol.Value, out var startDate))
            {
                startDate = date;
