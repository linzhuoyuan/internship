...
namespace QuantConnect.Data.Consolidators
{
    ...
    public class QuoteBarConsolidator : PeriodCountConsolidatorBase<QuoteBar, QuoteBar>
    {
        ...
        protected override void AggregateBar(ref QuoteBar workingBar, QuoteBar data)
        {
            ...
            workingBar.UpdateItem();
            //workingBar.Open = workingBar.GetOpen();
            //workingBar.High = workingBar.GetHigh();
            //workingBar.Low = workingBar.GetLow();
            //workingBar.Close = workingBar.GetClose();
