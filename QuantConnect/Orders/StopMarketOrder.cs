...
namespace QuantConnect.Orders
{
    ...
    public class StopMarketOrder : Order
    {
        ...
        /// <summary>
        /// Signal showing the "StopMarketOrder" has been converted into a Market Order    add by pang
        /// </summary>
        ...
        public StopMarketOrder(Symbol symbol, decimal quantity, decimal stopPrice, DateTime time, string tag = "", IOrderProperties properties = null, StopPriceTriggerType stopPriceTriggerType = StopPriceTriggerType.LastPrice)
        ...
        {
            return string.Format("{0} at stop {1} {2}", base.ToString(), StopPrice.SmartRounding(),StopTriggered);
        }
