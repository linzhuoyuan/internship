...
namespace QuantConnect.Orders
{
    ...
    {
        internal readonly decimal? quantity;
        internal readonly decimal? limitPrice;
        internal readonly decimal? stopPrice;

        /// <summary>
        /// Gets <see cref="Orders.OrderRequestType.Update"/>
        /// </summary>
        public override OrderRequestType OrderRequestType => OrderRequestType.Update;
        ...
        /// </summary>
        public decimal? LimitPrice => limitPrice;

        /// <summary>
        /// Gets the new stop price of the order, null to not change the stop price
        /// </summary>
        public decimal? StopPrice => stopPrice;
        ...
        public override string ToString()
        {
            ...
            return $"{Time} UTC: Update Order: ({OrderId}) - {string.Join(", ", updates)} {Tag} Status: {Status}";
        }
    }
}