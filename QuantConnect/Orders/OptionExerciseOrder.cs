...
namespace QuantConnect.Orders
{
    ...
    public class OptionExerciseOrder : Order
    {
        ...
        public OptionExerciseOrder(
            ...
            DateTime time,
            string tag = "",
            IOrderProperties properties = null) : base(symbol, quantity, time, tag, properties)
        {
        ...
        /// </summary>
        public override OrderType Type => OrderType.OptionExercise;

        /// <summary>
        /// Gets the order value in option contracts quoted in option's currency
        /// </summary>
