...
namespace QuantConnect.Orders.Fills
{
    ...
    public class FillModel : IFillModel
    {
        ...
        public virtual Prices GetPrices(Security asset, OrderDirection direction)
        {
            var low = asset.Low;
            var high = asset.High;
            var open = asset.Open;
        ...
        public class Prices
        {
            ...
            {
                return $"EndTime {EndTime.ToString("yyyy-MM-dd hh:mm:ss ffff")} Current:{Current} Open:{Open} High:{High} Low:{Low} Close:{Close}";
            }
        }
    }
}