...
namespace QuantConnect.Orders.Fills
{
    ...
    /// </summary>
    public class DeribitOptionFillModel : ImmediateFillModel
    {
        /// <summary>
        ...
        public override Prices GetPrices(Security asset, OrderDirection direction)
        {
            var low = asset.Low;
            var high = asset.High;
            var open = asset.Open;
            ...
            if (quoteBar != null)
            {
                if (tradeBar != null && tradeBar.endTime == quoteBar.endTime)
                {
                    ...
                    bar.High = Math.Max(tradeBar.High, bar.High);
                    bar.Low = Math.Min(tradeBar.Low, bar.Low);
