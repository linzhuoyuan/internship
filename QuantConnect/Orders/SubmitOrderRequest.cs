...
namespace QuantConnect.Orders
{
    ...
    public class SubmitOrderRequest : OrderRequest
    {
        ...
        /// </summary>
        public override OrderRequestType OrderRequestType => OrderRequestType.Submit;
        ...
        /// 
        /// </summary>
        public decimal LimitPriceAdvence
        {
            get; private set;
        }
        /// <summary>
        ...
        /// 
        /// </summary>
        public StopPriceTriggerType StopPriceTriggerType
        {
            get; private set;
        }
        ...
        /// 通知策略OrderId的变动 
        /// </summary>
        public Action<long> IdCallback { get; set; }
        ...
        public SubmitOrderRequest(OrderType orderType, SecurityType securityType, Symbol symbol, decimal quantity, decimal stopPrice, decimal limitPrice, DateTime time, string tag, IOrderProperties properties = null,OrderOffset offset = OrderOffset.None,decimal limitPriceAdvence = 0, string advence = "", StopPriceTriggerType stopPriceTriggerType = StopPriceTriggerType.LastPrice)
            : base(time, (int)OrderResponseErrorCode.UnableToFindOrder, tag)
        {
            ...
            Offset = offset;
            LimitPriceAdvence = limitPriceAdvence;
            Advence = advence;
            StopPriceTriggerType = stopPriceTriggerType;
        }
        ...
        public override string ToString()
        {
            ...
            return $"{Time} UTC: Submit Order: ({OrderId}) - {proxy} {Tag}" + " Status: " + Status;
        }
    }
}