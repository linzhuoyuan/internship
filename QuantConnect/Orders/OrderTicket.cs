...
namespace QuantConnect.Orders
{
    ...
    public sealed class OrderTicket
    {
        ...
        /// </summary>
        public Symbol Symbol => _submitRequest.Symbol;

        /// <summary>
        /// Gets the <see cref="Symbol"/>'s <see cref="SecurityType"/>
        /// </summary>
        public SecurityType SecurityType => _submitRequest.SecurityType;

        /// <summary>
        /// Gets the number of units ordered
        /// </summary>
        public decimal Quantity => _order?.Quantity ?? _submitRequest.Quantity;

        /// <summary>
        /// Gets the average fill price for this ticket. If no fills have been processed
        /// then this will return a value of zero.
        /// </summary>
        public decimal AverageFillPrice => _averageFillPrice;

        /// <summary>
        /// Gets the total quantity filled for this ticket. If no fills have been processed
        /// then this will return a value of zero.
        /// </summary>
        public decimal QuantityFilled => _quantityFilled;

        /// <summary>
        /// Gets the time this order was last updated
        /// </summary>
        public DateTime Time => GetMostRecentOrderRequest().Time;

        /// <summary>
        /// Gets the type of order
        /// </summary>
        public OrderType OrderType => _submitRequest.OrderType;

        /// <summary>
        /// Gets the order's current tag
        /// </summary>
        public string Tag => _order == null ? _submitRequest.Tag : _order.Tag;

        /// <summary>
        /// Gets the <see cref="SubmitOrderRequest"/> that initiated this order
        /// </summary>
        public SubmitOrderRequest SubmitRequest => _submitRequest;
        ...
        /// </summary>
        public WaitHandle OrderClosed => _orderStatusClosedEvent;
        ...
        public static implicit operator long(OrderTicket ticket)
        {
            ...
            {
                return (long) response.ErrorCode;
            }
