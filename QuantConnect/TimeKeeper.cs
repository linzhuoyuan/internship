...
namespace QuantConnect
{
    ...
    public class TimeKeeper : ITimeKeeper
    {
        ...
        private List<LocalTimeKeeper> _list;

        /// <summary>
        /// Gets the current time in UTC
        /// </summary>
        public DateTime UtcTime => _utcDateTime;
        ...
        public TimeKeeper(DateTime utcDateTime, IEnumerable<DateTimeZone> timeZones)
        {
            ...
            _list = _localTimeKeepers.Values.ToList();
        }
        ...
        {
            if (!_localTimeKeepers.TryGetValue(timeZone.Id, out var localTimeKeeper))
            {
