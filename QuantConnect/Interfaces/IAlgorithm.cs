...
namespace QuantConnect.Interfaces
{
    ...
    public interface IAlgorithm : ISecurityInitializerProvider, IAccountCurrencyProvider
    {
        ...
        ICryptoChainProvider CryptoChainProvider
        {
            get;
        }
        ...
        /// 
        /// </summary>
        /// <param name="data">Dividends</param>
        void OnData(Dividends data);
        ...
        void SetSupportAutoOpenClose(bool autoOpenClose);
        ...
        /// <summary>
        /// Get the CustomerChartData added  for dynamic plotting.
        /// </summary>
        /// <remarks>GetCustomerChartDataAdds returns the latest add since previous request.</remarks>
        List<CustomerChartData> GetCustomerChartDataAdds();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        List<GreeksChartData> GetGreeksChartData();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        List<GreeksPnlChartData> GetGreeksPnlChartData();
        ...
        /// <param name="properties">Symbol Properties</param>
        Security AddSecurity(
            ...
            SymbolProperties properties = null,
        ...
        void SetCryptoChainProvider(ICryptoChainProvider cryptoChainProvider);
        ...
        /// brokerage trade
        /// </summary>
        ConcurrentDictionary<string, TradeRecord> TradeRecords { get; }

        /// <summary>
        /// 
        /// </summary>
        ConcurrentDictionary<string, OrderRecord> OrderRecords { get; }
        ...
        void OnQueryOpenOrder(Order order, string requestId);
        ...
        /// <param name="requestId"></param>
        void OnQueryAccountHolding(Holding holding, string requestId);
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="requestId"></param>
        void OnQueryCashBalance(CashAmount balance, string requestId);



        void QueryExchangeOpenOrders(string uId, string requestId);

        void OnQueryExchangeOpenOrders(Order order, string requestId, bool isLast);

        void QueryExchangeAccountHolding(string uId, string requestId);

        void OnQueryExchangeAccountHolding(Holding holding, string requestId, bool isLast);

        void QueryExchangeCashBalance(string uId, string requestId);

        void OnQueryExchangeCashBalance(CashAmount balance, string requestId, bool isLast);

        void OnTransferCompleted(decimal amount, UserTransferType type, string currency);

        void OnTransferFailed(decimal amount, UserTransferType type, string currency, string error);

        void OnRiskDegreeChanged(decimal riskDegree, decimal userRiskDegree);

        void OnSplitNum(int max_split, decimal tradeVolume, string coin_pair);

        Func<decimal, string, decimal, decimal, int> RequestSplitNum {get; set;}

        void OnSymbolListed(List<Symbol> symbols);
        void OnSymbolDelisted(List<Symbol> symbols);

        void OnSettlementNotice(
        ...
        IEnumerable<BrokerageAccountInfo> BrokerageAccountInfos { get; set; }
        IDictionary<string, BrokerageAccountInfo> BrokerageAccountMap { get; set; }

        Func<Symbol, decimal> GetMarketPriceFromSnapshot { get; set; }

        Action<Symbol> BrokerageSubscribe { get; set; }
        Action<Symbol> BrokerageUnsubscribe { get; set; }

        void LoadBacktestInitPosition();
        Action BacktestInitPositionAction { get; set; }

        /// <summary>
        /// 从策略中正常退出
        /// </summary>
        CancellationTokenSource ExitTokenSource { get; set; }

        DateTimeOffset LiveStartTime { get; set; }
        DateTimeOffset LiveStopTime { get; set; }
        void WaitForLiveStart(Isolator isolator, DateTimeOffset? utcNow = null);
    }
}
