...
namespace QuantConnect.Interfaces
{
    ...
    public interface IApi : IDisposable
    {
        ...
        Link ReadDataLink(Symbol symbol, Resolution resolution, DateTime date, string stype = "quote");
        ...
        Stream DownloadData(Symbol symbol, Resolution resolution, DateTime date, string stype = "quote");
        ...
        void SendStatistics(string algorithmId, decimal unrealized, decimal fees, decimal netProfit, decimal holdings, decimal equity, decimal netReturn, decimal volume, long trades, double sharpe);
