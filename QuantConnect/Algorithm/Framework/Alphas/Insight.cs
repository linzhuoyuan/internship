...
namespace QuantConnect.Algorithm.Framework.Alphas
{
    ...
    public class Insight
    {
        ...
        public Insight(
            ...
            double? magnitude,
            double? confidence)
            : this(symbol, period, type, direction, magnitude, confidence, null, null)
        {
        }
        ...
        public Insight(
            ...
            : this(symbol, new FuncPeriodSpecification(expiryFunc), type, direction, magnitude, confidence, sourceModel)
        {
        }
        ...
        public Insight(
            ...
            double? confidence,
            string sourceModel = null,
            double? weight = null) : this(symbol, period, type, direction, magnitude, confidence, sourceModel, weight)
        {
