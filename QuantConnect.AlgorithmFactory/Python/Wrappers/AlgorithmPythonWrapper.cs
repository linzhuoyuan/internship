...
namespace QuantConnect.AlgorithmFactory.Python.Wrappers
{
    ...
    public class AlgorithmPythonWrapper : IAlgorithm
    {
        ...
        {
            get => _baseAlgorithm.BrokerageMessageHandler;
        ...
        {
            get => _baseAlgorithm.HistoryProvider;
        ...
        public bool SimulationMode => _baseAlgorithm.SimulationMode;
        ...
        {
            get => _baseAlgorithm.RunTimeError;
        ...
        /// <summary>
        /// Gets the exit code from the algorithm, It is explanined by the exception.
        /// </summary>
        public int ExitCode
        {
            get => _baseAlgorithm.ExitCode;
        ...
        public ICryptoChainProvider CryptoChainProvider { get; }
        ...
        public void SetCryptoChainProvider(ICryptoChainProvider cryptoChainProvider) => _baseAlgorithm.SetCryptoChainProvider(cryptoChainProvider);
        ...
        /// <summary>
        /// Gets whether or not this algorithm is need update security ContractMultiplier
        /// </summary>
        public bool IsNeedUpdateContractMultiplier
        {
            get;
            set;
        }
        ...
        /// <param name="dataNormalizationMode"></param>
        public Security AddSecurity(SecurityType securityType, string symbol, Resolution resolution, string market,
            bool fillDataForward, decimal leverage, bool extendedMarketHours, SymbolProperties properties = null,
            DataNormalizationMode dataNormalizationMode = DataNormalizationMode.Adjusted)
        {
            return _baseAlgorithm.AddSecurity(securityType, symbol, resolution, market, fillDataForward, leverage, extendedMarketHours, properties, dataNormalizationMode);
        }
        ...
        /// 期权分红调整
        /// </summary>
        /// <param name="data">期权分红数据</param>
        public void OnData(Dividends data)
        {
            using (Py.GIL())
            {
                _baseAlgorithm.OnData(data);
            }
        }
        ...
        public void OnMarginCall(List<SubmitOrderRequest> requests)
        {
            try
            {
                using (Py.GIL())
                {
                    ...
                    {
                        if (TryConvert(pyRequest, out SubmitOrderRequest request))
                        {
        ...
        public virtual void OnSplitNum(int max_split, decimal tradeVolume, string coin_pair) {
            _baseAlgorithm.OnSplitNum(max_split, tradeVolume, coin_pair);
        }

        public Func<decimal, string, decimal, decimal, int> RequestSplitNum {
            get => _baseAlgorithm.RequestSplitNum;
            set => _baseAlgorithm.RequestSplitNum = value;
        }

        public void SetEndDate(DateTime end)
        {
            _baseAlgorithm.SetEndDate(end);
        }
        ...
        {
            _baseAlgorithm.SetStartDate(start);
        }
        ...
        /// <summary>
        /// Get the customerchart update
        /// </summary>
        /// <remarks>GetChartJsonAdds returns the latest add since previous request.</remarks>
        public List<CustomerChartData> GetCustomerChartDataAdds() => _baseAlgorithm.GetCustomerChartDataAdds();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public List<GreeksChartData> GetGreeksChartData() => _baseAlgorithm.GetGreeksChartData();

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public List<GreeksPnlChartData> GetGreeksPnlChartData() => _baseAlgorithm.GetGreeksPnlChartData();

        /// <summary>
        /// 
        /// </summary>
        public string PortfolioManagerName => _baseAlgorithm.PortfolioManagerName;

        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
        public bool MarkPriceReady() { return _baseAlgorithm.MarkPriceReady(); }

        /// <summary>
        /// 
        /// </summary>
        public ConcurrentDictionary<string, TradeRecord> TradeRecords => _baseAlgorithm.TradeRecords;

        /// <summary>
        /// 
        /// </summary>
        public ConcurrentDictionary<string, OrderRecord> OrderRecords => _baseAlgorithm.OrderRecords;
        ...
        {
            get => _baseAlgorithm.StartingPortfolioValue;
            set => _baseAlgorithm.StartingPortfolioValue = value;
        }
        ...
        /// </summary>
        /// <returns></returns>
        public void QueryOpenOrders(string requestId)
        {
            _baseAlgorithm.QueryOpenOrders(requestId);
        }

        public void OnQueryOpenOrder(Order order, string requestId)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public void QueryAccountHoldings(string requestId)
        {
            _baseAlgorithm.QueryAccountHoldings(requestId);
        }

        public void OnQueryAccountHolding(Holding holding, string requestId)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public void QueryCashBalance(string requestId)
        {
            _baseAlgorithm.QueryCashBalance(requestId);
        }
        public void OnQueryCashBalance(CashAmount balance, string requestId)
        {
        }

        public void QueryExchangeOpenOrders(string uId, string requestId)
        {
            _baseAlgorithm.QueryExchangeOpenOrders(uId, requestId);
        }


        public void OnQueryExchangeOpenOrders(Order order, string requestId, bool isLast)
        {

        }

        public void QueryExchangeAccountHolding(string uId, string requestId)
        {
            _baseAlgorithm.QueryExchangeAccountHolding(uId, requestId);
        }

        public void OnQueryExchangeAccountHolding(Holding holding, string requestId, bool isLast)
        {

        }

        public void QueryExchangeCashBalance(string uId, string requestId)
        {
            _baseAlgorithm.QueryExchangeCashBalance(uId, requestId);
        }

        public void OnQueryExchangeCashBalance(CashAmount balance, string requestId, bool isLast)
        {

        }

        public void OnTransferCompleted(decimal amount, UserTransferType type, string currency)
        {
        }

        public void OnTransferFailed(decimal amount, UserTransferType type, string currency, string error)
        {
        }

        public void OnRiskDegreeChanged(decimal riskDegree, decimal userRiskDegree)
        {

        }

        public void OnSymbolListed(List<Symbol> symbols)
        {
        }

        public void OnSymbolDelisted(List<Symbol> symbols)
        {

        }

        public void OnSettlementNotice(
            IEnumerable<Dictionary<string, string>> assigned,
            IEnumerable<Dictionary<string, string>> dividend,
            IEnumerable<Dictionary<string, string>> missing)
        {
        }

        public void OnProgramExit()
        {
            _baseAlgorithm.OnProgramExit();
        }
        ...
        {
            get => _baseAlgorithm.CanTrade;
            set => _baseAlgorithm.SetCanTrade(value);
        }
        /// <summary>
        /// 
        /// </summary>
        /// <param name="canTrade"></param>
        public void SetCanTrade(bool canTrade)
        {
            _baseAlgorithm.SetCanTrade(canTrade);
        }

        public Action<Symbol> BrokerageSubscribe
        {
            get => _baseAlgorithm.BrokerageSubscribe;
            set => _baseAlgorithm.BrokerageSubscribe = value;
        }

        public Action<Symbol> BrokerageUnsubscribe
        {
            get => _baseAlgorithm.BrokerageUnsubscribe;
            set => _baseAlgorithm.BrokerageUnsubscribe = value;
        }

        public void LoadBacktestInitPosition()
        {
            _baseAlgorithm.LoadBacktestInitPosition();
        }

        public Action BacktestInitPositionAction
        {
            get => _baseAlgorithm.BacktestInitPositionAction;
            set => _baseAlgorithm.BacktestInitPositionAction = value;
        }

        public CancellationTokenSource ExitTokenSource
        {
            get => _baseAlgorithm.ExitTokenSource;
            set => _baseAlgorithm.ExitTokenSource = value;
        }

        public DateTimeOffset LiveStartTime
        {
            get => _baseAlgorithm.LiveStartTime;
            set => _baseAlgorithm.LiveStartTime = value;
        }

        public DateTimeOffset LiveStopTime
        {
            get => _baseAlgorithm.LiveStopTime;
            set => _baseAlgorithm.LiveStopTime = value;
        }

        public void WaitForLiveStart(Isolator isolator, DateTimeOffset? utcNow = null)
        {
            _baseAlgorithm.WaitForLiveStart(isolator, utcNow);
        }

        public IEnumerable<BrokerageAccountInfo> BrokerageAccountInfos
        {
            get => _baseAlgorithm.BrokerageAccountInfos;
            set => _baseAlgorithm.BrokerageAccountInfos = value;
        }

        public IDictionary<string, BrokerageAccountInfo> BrokerageAccountMap
        {
            get => _baseAlgorithm.BrokerageAccountMap;
            set => _baseAlgorithm.BrokerageAccountMap = value;
        }

        public Func<Symbol, decimal> GetMarketPriceFromSnapshot
        {
            get => _baseAlgorithm.GetMarketPriceFromSnapshot;
            set => _baseAlgorithm.GetMarketPriceFromSnapshot = value;
        }

        public void SetSupportAutoOpenClose(bool autoOpenClose)
        {
            _baseAlgorithm.SetSupportAutoOpenClose(autoOpenClose);
        }
    }
}