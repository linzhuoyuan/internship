...
namespace MomCrypto.Api
{
    public sealed class MomOrderPriceTypeType
    {
        ...
        [Description(nameof(SettlementPrice))]
        public const byte SettlementPrice = (byte)'J';
        [Description(nameof(MomSettlementPrice))]
        public const byte MomSettlementPrice = (byte)'K';
    }
}
